    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (string j in jobs){ 
                ...
                string sourceFile = System.IO.Path.Combine(searchPath, job+".pdf");
                string destFile = System.IO.Path.Combine(movePath, job + ".pdf");

                if (!System.IO.Directory.Exists(movePath))
                {
